...
import com.octavi.lab.fragments.OctaviAmbientService;
...
public final class DozeUtils {
    ...
    private static void startService(Context context) {
        ...
        context.startServiceAsUser(new Intent(context, OctaviAmbientService.class),
                UserHandle.CURRENT);
    ...
    private static void stopService(Context context) {
        ...
        context.stopServiceAsUser(new Intent(context, OctaviAmbientService.class),
                UserHandle.CURRENT);
    }
