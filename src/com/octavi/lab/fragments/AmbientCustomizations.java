...
import com.octavi.support.preferences.SystemSettingEditTextPreference;
...
public class AmbientCustomizations extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle icicle) {
        ...
        addPreferencesFromResource(R.xml.octavi_ambient_customization);
    ...
    public static final SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                public List<SearchIndexableResource> getXmlResourcesToIndex(Context context,
                    ...
                    sir.xmlResId = R.xml.octavi_ambient_customization;
                    result.add(sir);
                    return result;
                }
